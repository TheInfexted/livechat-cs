...
class ChatModel extends Model
{
    ...
    protected $allowedFields = ['session_id', 'customer_name', 'customer_fullname', 'chat_topic', 'customer_email', 'user_role', 'external_username', 'external_fullname', 'external_system_id', 'agent_id', 'api_key', 'status', 'closed_at'];
